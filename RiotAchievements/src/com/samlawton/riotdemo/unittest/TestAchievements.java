...
public class TestAchievements {
	...
	public void testUpdatePlayer() {
		...
		testStatUpdater.updateStats(jdbcParams);
		...
		Game testGame2 = new Game(gamePlayers);
		testGame2.init(jdbcParams);
		...
		testStatUpdater2.updateStats(jdbcParams);
	...
	public void testAchievementCreationAndUpdate() {
			...
			try {
				...
				if (testRS.next()) {
					...
					assertEquals("This should be false.", false,
							testRS.getBoolean(Player.SHARPSHOOTER_IDX));
					assertEquals("This should be false.", false,
							testRS.getBoolean(Player.BRUISER_IDX));
					assertEquals("This should be false.", false,
							testRS.getBoolean(Player.VETERAN_IDX));
					assertEquals("This should be false.", false,
							testRS.getBoolean(Player.BIG_WINNER_IDX));
		...
		updateAchieves.updateStats(jdbcParams);
	}
